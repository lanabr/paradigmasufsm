...
#9.Crie uma função charFound(c,s) que verifique se o caracter c está
#contido na string. O resultado deve ser True ou False. Você não deve
#usar o operador in. Defina uma função auxiliar para ajudar neste exercício.
